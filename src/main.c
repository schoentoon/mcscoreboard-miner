...
static int extended_help() {
  ...
  fprintf(stderr, "'stats_useitem_format', Amount of times an item is used.\n");
  fprintf(stderr, "  %%username   The username of the player.\n");
  fprintf(stderr, "  %%id         The id of the item used.\n");
  fprintf(stderr, "  %%value      The amount of times the item is used.\n");
  fprintf(stderr, "'stats_mineblock_format', Amount of times a block is mined.\n");
  fprintf(stderr, "  %%username   The username of the player.\n");
  fprintf(stderr, "  %%id         The id of the block mined.\n");
  fprintf(stderr, "  %%value      The amount of times the block is mined.\n");
  fprintf(stderr, "'stats_craftitem_format', Amount of times an item is crafted.\n");
  fprintf(stderr, "  %%username   The username of the player.\n");
  fprintf(stderr, "  %%id         The id of the crafted item.\n");
  fprintf(stderr, "  %%value      The amount of times the item is crafted.\n");
  fprintf(stderr, "'stats_breakitem_format', Amount of times an item is broken.\n");
  fprintf(stderr, "  %%username   The username of the player.\n");
  fprintf(stderr, "  %%id         The id of the broken item.\n");
  fprintf(stderr, "  %%value      The amount of times the item is broken.\n");
  fprintf(stderr, "'stats_killentity_format', Amount of times a certain mod is killed by the player.\n");
  fprintf(stderr, "  %%username   The username of the player.\n");
  fprintf(stderr, "  %%id         The name of the killed mob.\n");
  fprintf(stderr, "  %%value      The amount of times the mob is killed.\n");
  fprintf(stderr, "'stats_killedbyentity_format', Amount of times the player is killed by a certain mob.\n");
  fprintf(stderr, "  %%username   The username of the player.\n");
  fprintf(stderr, "  %%id         The name of the mob that killed the player.\n");
  fprintf(stderr, "  %%value      The amount of times the mob has killed the player.\n");
  fprintf(stderr, "'stats_format', Other stats.\n");
  fprintf(stderr, "  %%username   The username of the player.\n");
  fprintf(stderr, "  %%id         The name of the stat.\n");
  fprintf(stderr, "  %%value      The counter of this stat.\n");
  return 0;
};
